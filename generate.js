...
(function() {
  window.generate_combinations = {
    ...
    9: [[['A', 'B'], ['C', 'D']], [[2, 5], [3, 4]], [['A', 'C'], ['B', 'D']], [[1, 5], [2, 4]], [['A', 'D'], ['B', 'C']], [[1, 2], [3, 5]], [['B', 2], ['A', 'C']], [[1, 3], [4, 5]], [['A', 5], ['B', 'D']], [[1, 4], [2, 3]], [['A', 4], [2, 3]], [['D', 1], ['C', 5]], [['B', 5], ['D', 3]], [['C', 2], [1, 4]], [['A', 3], [1, 2]], [['C', 1], ['B', 'D']], [['A', 'D'], [1, 5]], [['B', 'C'], [3, 4]]].map(function(teams) {
  ...
  window.generate = function(players) {
    ...
    ref2 = window.generate_combinations[players];
